...
# dataset settings
dataset_type = 'QuantCocoDatasetV3'
data_root = 'data/quant-voc-v5/'
backend_args = None
...
train_dataloader = dict(
    ...
    dataset=dict(
        ...
        data_root=data_root,
        max_size=1000,
        ann_file='annotations/trainv10_balanced.json',
        data_prefix=dict(img='train_balanced_v10/images/'),
...
val_dataloader = dict(
    ...
    dataset=dict(
        type=dataset_type,
        data_root=data_root,
        ann_file='annotations/testv6.json',
...
val_evaluator = dict(
    type='CocoMetric',
    ann_file=data_root + 'annotations/testv6.json',
    metric=['bbox'],
    format_only=False,
    backend_args=backend_args)
test_evaluator = val_evaluator
load_from = 'checkpoints-0103.pth'
evaluation = dict(interval=1, metric='bbox')

fp16 = dict(loss_scale=512.)

checkpoint_config = dict(interval=4)
load_from = 'rfla_cascade_epoch_12.pth'
