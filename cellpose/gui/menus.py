...
def mainmenu(parent):
    ...
    parent.saveFlows = QAction("Save Visualization and Mesurements as .png and .csv", parent)
    parent.saveFlows.setShortcut("Ctrl+F")
    parent.saveFlows.triggered.connect(lambda: io._save_visualization(parent))
